...
<html lang="en">
  <head>
    ...
    <title>Input Mata Kuliah | ARMY University</title>
  </head>
  <body>
        ...
        <div class="form-mhs mt-2">
          ...
          <form action="#" method="post" class="tbl mt-4">
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Kode Mata Kuliah</label>
              <div class="col-sm-10">
            ...
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Nama Mata Kuliah</label>
              <div class="col-sm-10">
                <input type="number" class="form-control" id="colFormLabel" placeholder="">
              </div>
            </div>
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">SKS</label>
              <div class="col-sm-10">
                <input type="number" class="form-control" id="colFormLabel" placeholder="">
              </div>
            </div>
