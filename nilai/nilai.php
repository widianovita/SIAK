    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
        <ul class="nav flex-column ml-3 mb-5">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="nilai.php"><i class="fas fa-money-check mr-2"></i> Nilai Mahasiswa</a><hr class="bg-secondary">
          </li>
        </ul>
      </div>
      <div class="col-md-10 p-5 pt-4">
        <h3><i class="fas fa-money-check mr-2"></i> NILAI</h3><hr>
        ...
        <div class="row">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-sm mt-3 ml-3">
              ...
              <tbody>
                <tr>
                  ...
                  <td></td>
                  <td>
                    <a class="btn btn-warning ml-2" href="#" role="button">Edit</a> 
                    <a class="btn btn-danger ml-2" href="#" role="button">Delete</a>
                  </td>
                </tr>
              </tbody>
            </table>
