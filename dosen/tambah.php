...
<html lang="en">
  <head>
    ...
    <title>Input Data Dosen | ARMY University</title>
  </head>
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-4">
        ...
        <div class="form-mhs mt-2">
          ...
          <form action="#" method="post" class="tbl mt-4">
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">No Urut Dosen</label>
              <div class="col-sm-10">
            ...
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Kode Jabatan</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="">
              </div>
            </div>
